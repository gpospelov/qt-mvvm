...
SplitLayerEditor::SplitLayerEditor(QWidget* parent)
    : QWidget(parent)
    , m_material_view(new QTableView)
    , m_sample_table(LayerEditorUtils::createShrinkedLayerTable())
...
QVBoxLayout* SplitLayerEditor::createMaterialPanel()
{
...
QVBoxLayout* SplitLayerEditor::createMultilayerPanel()
{
    auto layout = new QVBoxLayout;
    auto layout_h = new QHBoxLayout;
