...
namespace {
	...
	{
	public:
		DisabledFadingPanel(QWidget* parent = nullptr)
			: Utils::FadingPanel(parent)
		{}
		void fadeTo(qreal) override {}
		void setOpacity(qreal) override {}
	};

	void setSpinBoxToDetailsWidget(Utils::DetailsWidget* details_widget, const QModelIndex& index)
	{
