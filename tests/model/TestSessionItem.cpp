...
TEST_F(TestSessionItem, tagRowFromItem)
{
    ...
    EXPECT_EQ(parent->tagIndexOfItem(child_t1_a).second, 0);
    EXPECT_EQ(parent->tagIndexOfItem(child_t1_b).second, 1);
    EXPECT_EQ(parent->tagIndexOfItem(child_t2_a).second, 0);
    EXPECT_EQ(parent->tagIndexOfItem(child_t2_b).second, 1);
    EXPECT_EQ(parent->tagIndexOfItem(child_t2_c).second, 2);

    EXPECT_EQ(parent->tagIndexOfItem(child_t1_a).first, "tag1");
    EXPECT_EQ(parent->tagIndexOfItem(child_t1_b).first, "tag1");
    EXPECT_EQ(parent->tagIndexOfItem(child_t2_a).first, "tag2");
    EXPECT_EQ(parent->tagIndexOfItem(child_t2_b).first, "tag2");
    EXPECT_EQ(parent->tagIndexOfItem(child_t2_c).first, "tag2");
}
