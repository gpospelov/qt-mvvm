...
TEST_F(TestJsonUtils, CreateLimits)
{
    ...
    EXPECT_EQ(JsonUtils::CreateLimits("lowerLimited", 1.0), RealLimits::lowerLimited(1.0));
    EXPECT_EQ(JsonUtils::CreateLimits("upperLimited", 42.0), RealLimits::upperLimited(42.0));
